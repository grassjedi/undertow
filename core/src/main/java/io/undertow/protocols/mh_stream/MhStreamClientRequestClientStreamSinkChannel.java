...
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_AUTH_TYPE;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_QUERY_STRING;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_REMOTE_USER;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_ROUTE;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_SECRET;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_SSL_CERT;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_SSL_CIPHER;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_SSL_KEY_SIZE;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_SSL_SESSION;
import static io.undertow.protocols.mh_stream.AjpConstants.ATTR_STORED_METHOD;
import static io.undertow.protocols.mh_stream.AjpUtils.notNull;
import static io.undertow.protocols.mh_stream.AjpUtils.putString;
...
public class MhStreamClientRequestClientStreamSinkChannel extends AbstractMhStreamClientStreamSinkChannel {

    private final ChannelListener<MhStreamClientRequestClientStreamSinkChannel> finishListener;
    ...
    MhStreamClientRequestClientStreamSinkChannel(AjpClientChannel channel, ChannelListener<MhStreamClientRequestClientStreamSinkChannel> finishListener, HeaderMap headers, String path, HttpString method, HttpString protocol, Attachable attachable) {
        super(channel);
    ...
    */
        ...
        if (!firstFrameWritten) {
            ...
            io.undertow.protocols.mh_stream.AjpUtils.putHttpString(buffer, protocol);
