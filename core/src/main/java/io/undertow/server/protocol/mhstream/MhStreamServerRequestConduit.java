...
public class MhStreamServerRequestConduit extends AbstractStreamSourceConduit<StreamSourceConduit> {
    ...
    private final MhStreamServerResponseConduit mhStreamServerResponseConduit;
    ...
    private final ConduitListener<? super MhStreamServerRequestConduit> finishListener;
    ...
    public MhStreamServerRequestConduit(
            final StreamSourceConduit delegate, HttpServerExchange exchange,
            MhStreamServerResponseConduit mhStreamServerResponseConduit,
            Long size, ConduitListener<? super MhStreamServerRequestConduit> finishListener) {
        super(delegate);
        this.exchange = exchange;
        this.mhStreamServerResponseConduit = mhStreamServerResponseConduit;
    ...
    public int read(ByteBuffer dst) throws IOException {
        try {
            ...
            if (anyAreSet(state, STATE_FINISHED)) {
                ...
                if (mhStreamServerResponseConduit.isWriteShutdown()) {
                ...
                if (!mhStreamServerResponseConduit.doGetRequestBodyChunk(READ_BODY_CHUNK.duplicate(), this)) {
                    return 0;
                }
            }
